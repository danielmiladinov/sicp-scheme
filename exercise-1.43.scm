...
; that raises its argument to the 2n-th power. Write a procedure that takes as inputs a procedure that
; computes f and a positive integer n and returns the procedure that computes the nth repeated application of f.
...
(define (repeated func times)
  (cond ((= times 1) func)
        (else (compose func (repeated func (- times 1))))))
